...
export const SAMPLE_ITEMS: SampleItem[] = [
  ...
  {
    id: "car_petrol",
    name: "Petrol Passenger Car (Sedan)",
    category: "transport",
    default_unit: "km",
    default_quantity: 50,
    default_factor: 0.12,
    factor_label: "Average Petrol Internal Combustion",
    icon: "Car",
  ...
  {
    id: "car_diesel",
    name: "Diesel SUV / Light Truck",
    category: "transport",
    default_unit: "km",
    default_quantity: 65,
    default_factor: 0.14,
    factor_label: "Heavy Diesel Fuel Combustion",
    icon: "Car",
  ...
  {
    id: "electricity",
    name: "Residential Grid Power Meter",
    category: "energy",
    default_unit: "kWh",
    default_quantity: 35,
    default_factor: 0.82,
    factor_label: "Average Coal/Gas Mixed National Grid",
    icon: "Zap",
  ...
  {
    id: "waste",
    name: "Landfill Waste Dumpster",
    category: "waste",
    default_unit: "hours",
    default_quantity: 24,
    default_factor: 0.45,
    factor_label: "Mixed Municipal Decomposing Waste",
    icon: "Trash2",
